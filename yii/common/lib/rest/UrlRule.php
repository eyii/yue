...
class UrlRule extends CompositeUrlRule
{
    ...
    public function createUrl($manager, $route, $params)
    {
        ...
        foreach ($this->controller as $urlName => $controller) {
            ...
            } else$this->createStatus |= WebUrlRule::CREATE_STATUS_ROUTE_MISMATCH;

        }

        if ($this->createStatus === WebUrlRule::CREATE_STATUS_SUCCESS) $this->createStatus = WebUrlRule::CREATE_STATUS_PARSING_ONLY;
