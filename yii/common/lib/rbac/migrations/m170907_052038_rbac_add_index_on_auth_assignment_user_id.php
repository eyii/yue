...
class m170907_052038_rbac_add_index_on_auth_assignment_user_id extends Migration
{
    ...
    protected function getAuthManager()
    {
        ...
        if (!$authManager instanceof DbManager) throw new InvalidConfigException('You should configure "authManager" component to use database before executing this migration.');
