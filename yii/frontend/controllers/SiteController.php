...
class SiteController extends Controller
{
    ...
    public function actionRequestPasswordReset()
    {
        ...
        if (!$model->load(Yii::$app->request->post()) && $model->validate()) $this->render('requestPasswordResetToken', ['model' => $model,]);
         if (!$model->sendEmail()) return Yii::$app->session->setFlash('error', 'Sorry, we are unable to reset password for the provided email address.');
