...
class Action extends Component
{
    ...
    {
        if (!method_exists($this, 'run')) throw new InvalidConfigException(get_class($this) . ' must define a "run()" method.');

        $args = $this->controller->bindActionParams($this, $params);
        Yii::debug('Running action: ' . get_class($this) . '::run()', __METHOD__);
        if (Yii::$app->requestedParams === null) Yii::$app->requestedParams = $args;
